...
/* Como compilar: gcc prog2.c conio_v3.2.4.c -o prog1.exe -Wall -pedantic -Wextra */
...
/* Exercícios:
   1) As linhas 53 e 56 são repetidas. Como poderia modificar o programa para ter somente uma linha dessas escrita no código, mas sem modificar o que o programa faz.
